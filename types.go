// Package ravenixfi provides the Go SDK for the virexon Fi privacy-native neo bank protocol.
package ravenixfi
...
// virexonError is the structured error returned by the virexon API.
type virexonError struct {
...
func (e virexonError) Error() string {
...
// virexonConfig holds the configuration for an virexonClient.
type virexonConfig struct {
	APIKey       string
	BaseURL      string
	WsURL        string
