...
// ConnectWebSocket opens a WebSocket connection to the RAVENIX real-time event stream.
...
func (c *RAVENIXClient) ConnectWebSocket(ctx context.Context) (<-chan WsEvent, error) {
...
func (c *RAVENIXClient) ConnectWebSocketReconnecting(ctx context.Context, cfg ReconnectConfig) (<-chan WsEvent, error) {
